...
class Decoder(nn.Module):
    ...
    '''
    def __init__(self, vocab_size, decoder_hidden_dim, embed_dim, key_value_size=128, gumbel=False, dropout=None):
...
class Seq2Seq(nn.Module):
    ...
    '''
    def __init__(self, input_dim, vocab_size, encoder_hidden_dim, decoder_hidden_dim, embed_dim, key_value_size=128, gumbel=False, encoder_dropout=None, decoder_dropout=None):
        super(Seq2Seq,self).__init__()
        self.encoder = Encoder(input_dim, encoder_hidden_dim, key_value_size=key_value_size, dropout=encoder_dropout)
        self.decoder = Decoder(vocab_size, decoder_hidden_dim, embed_dim, key_value_size=key_value_size, gumbel=gumbel, dropout=decoder_dropout)
